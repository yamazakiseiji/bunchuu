/***************************************************************************/
/* Copyright (C) 1992 (2010 - 2011) Renesas Electronics Corporation and    */
...
/* リエントラント用に_iob[]を追加 A SH-V.9.04.01 BSH009     */
#ifdef _REENTRANT
...
/* リエントラント時にマクロ展開をとめる C SH-V.9.04.01 BSH009   */
#ifndef _REENTRANT
...
/* _IONBF用の判定を追加 C SH-V.9.04.01 BSH005   */
/* _IOLBF用の判定を変更 C SH-V.9.04.01 BSH007   */
